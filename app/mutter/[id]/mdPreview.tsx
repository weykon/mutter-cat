...
export default function MD({ data }: { data: any }) {
    ...
    return (
        <div className=" card min-h-[600px] flex flex-row">
            ...
            />}
            {
                editing && <textarea className="textarea textarea-secondary bg-base dark:bg-neutral text-2xl min-h-[300px] min-w-[300px]" placeholder="Bio" onChange={(e) => void setEditingContent(e.target.value)} value={editingContent}></textarea>
            }
